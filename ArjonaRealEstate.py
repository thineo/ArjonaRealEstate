...
print("Balance after", term_years ,"years ", (real_estate_value + br_account))
print("\n###################\n")
print("\n---Baseline balance: R$", baseline_account)
...
print("---RoI Real Estate: ", real_state_roi, "x in", term_years, "years")
print("---RoI Real Estate a.a: ", math.pow(real_state_roi, 1/term_years), "%")

print("\n--------------\n")
baseline_roi = baseline_account/investment_to_present_value
print("---Baseline ROI: ", baseline_roi, "x in", term_years, "years")
print("---Baseline ROI a.a: ", math.pow(baseline_roi, 1/term_years), "%")
